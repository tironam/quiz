let all_questions = [
    {
        question_string: `What show does the term "hotdog" come from?`,
        choices: {
            correct: 'Silicon Valley',
            wrong: ['The Big Bang Theory', 'Mr. Robot', 'Freaks & Geeks']
        }
    },
    {
        question_string: `Temperate Literals use:`,
        choices: {
            correct: 'Backticks',
            wrong: ['Curly Braces', 'Single Quotes', 'Double Quotes']
        }
    },
    {
        question_string: `A Boolean is a True/False statement?`,
        choices: {
            correct: 'True',
            wrong: ['False']
        }
    ...
    {
        question_string: `What popular styling library was made by Twitter?`,
        choices: {
            correct: 'Bootstrap',
            wrong: ['JQuery', 'Box Lunch', 'Pied Piper']
        }
    },
    {
        question_string: `W3 Schools is a:`,
        choices: {
            correct: 'Great coding resource',
            wrong: ['A styling library', 'Art school', 'Middle-out compression company']
        }
    },
    {
...
//     let index_to_add_question = 
//     Math.floor(Math.random() * this.questions.length)
//     this.questions.splice(index_to_add_questions, 0, question)
// }

// quiz.prototype.render = function(container) {
//     let self = this
//     document.getElemById('quiz-results').hide()
...
//     self.questions[current_questions_index].render(question_container)
//     document.getElementById('next-question-button').propertyName('disabled', current_question_index === self.questions.length -1)
...
//         }
//     }
//     document.getElementById('submit-button').propertyName('disabled', !all_questions_answered)
// }
